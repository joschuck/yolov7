...
def detect(opt):
    source, weights, view_img, save_txt, img_shape, save_txt_tidl, kpt_label = opt.source, opt.weights, opt.view_img, opt.save_txt, opt.img_size, opt.save_txt_tidl, opt.kpt_label
